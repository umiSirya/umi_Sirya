...
| **Libraries** | pandas, NumPy, Matplotlib, Seaborn, Plotly, Scikit-learn, TensorFlow, Keras, PyTorch, Geopandas |
| **Machine Learning** | Supervised & Unsupervised Learning, Deep Learning, NLP, Time Series (ARIMA, SARIMA, Prophet, LSTM) |
| **Databases** | MySQL, PostgreSQL |
| **Visualization** | Power BI, Tableau |
| **Other** | Google Colab, GitHub, Microsoft Excel, Google Sheets |
...
- Visualized findings in a Power BI dashboard
- [View Project](https://github.com/umiSirya/kenya_public_debt)
...
- Built an interactive Power BI dashboard tracking AHT, Pass Rate and Call Volume
- [View Project](https://github.com/umiSirya/callcentre_performance)
